  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "A Claude/MCP agent composes a Sky sUSDS workflow on KeeperHub. You review it, dry-run with no chain write, then that exact workflow executes.",
      },
