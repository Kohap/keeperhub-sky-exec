...
| Video | https://youtu.be/_jNeXn85wI0 |
...
Desk: [keeperhub-sky-exec.vercel.app/desk](https://keeperhub-sky-exec.vercel.app/desk). Pitch: [`/pitch`](https://keeperhub-sky-exec.vercel.app/pitch). Mechanism: [`/docs`](https://keeperhub-sky-exec.vercel.app/docs) · [`docs/MECHANISM.md`](docs/MECHANISM.md). Live project on the other side: **Sky (USDS/sUSDS)**, not this UI.
...
Script: [`docs/VIDEO.md`](docs/VIDEO.md). Capture: [youtu.be/_jNeXn85wI0](https://youtu.be/_jNeXn85wI0)
