...
2. Policy allow.
3. Dry-run: REST simulate of `USDS.approve(sUSDS, 0)` → `wouldRevert: false`.
4. Execute: MCP `execute_workflow` → run `r7grdajtci7hf757zd9xr`.
5. Explorer hash on Ethereum.
...
Script: [`docs/VIDEO.md`](docs/VIDEO.md).
